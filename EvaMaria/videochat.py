...
**▶ Playing song
🏷️ Name: [{songname}]({link})
❤ Sᴏᴜʀᴄᴇ: [CLICK here](https://github.com/Akbotmakersnew/LuciferVCbot-V2)
🎧 Requested by: {m.from_user.mention}**
""",
                )
...
**▶ Start Playing Song
🏷️ Name: [{songname}]({url})
❤ 𝐒𝐨𝐮𝐫𝐜𝐞: [here](https://github.com/Akbotmakersnew/LuciferVCbot-V2)
🎧 Requested by: {m.from_user.mention}**
""",
                            )
...
**▶ Start Playing Video
🏷️ Name: [{songname}]({url})
❤ 🅢︎🅞︎🅤︎🅡︎🅒︎🅔︎: [here](https://github.com/Akbotmakersnew/LuciferVCbot-V2)
🎬 Requested by: {m.from_user.mention}**
""",
                            )
                        except Exception as ep:
...
🏷️ Name: [{songname}]({link})
❤ 𝙎𝙤𝙪𝙧𝙘𝙚: [here](https://github.com/Akbotmakersnew/LuciferVCbot-V2)
